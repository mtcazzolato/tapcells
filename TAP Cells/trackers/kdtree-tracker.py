### 
# KDTree-Tracker: tracking cells from a developing embryo
...
def track(filepath, filenames):
    # seedAtCell comes from the last iteration, and stores the cell id in order for each point in the KDTree
    global seedAtCell
    global twangData
...
if __name__ == "__main__":
    if (len(sys.argv) != 4):
        ...
        print('Tracking using KDTree-Tracker...')
        main(sys.argv)
        print('Done.')
